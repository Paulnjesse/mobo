...
module.exports = (app) => {
  ...
  app.use(createProxyMiddleware('/api/v1/track', { target: RIDE_SERVICE,     changeOrigin: true, pathRewrite: { '^/api/v1/track': '/rides/track'    }, on: { error: onError } }));

  app.use(createProxyMiddleware('/api/auth',     { target: USER_SERVICE,     changeOrigin: true, pathRewrite: { '^/api/auth':     '/auth'     }, on: { error: onError } }));
  app.use(createProxyMiddleware('/api/v1/auth',  { target: USER_SERVICE,     changeOrigin: true, pathRewrite: { '^/api/v1/auth':  '/auth'     }, on: { error: onError } }));
  ...
  app.use(createProxyMiddleware('/api/v1/users', { target: USER_SERVICE,     changeOrigin: true, pathRewrite: { '^/api/v1/users': '/users'    }, on: { error: onError } }));
  ...
  app.use(createProxyMiddleware('/api/v1/fleet', { target: USER_SERVICE,     changeOrigin: true, pathRewrite: { '^/api/v1/fleet': '/fleet'    }, on: { error: onError } }));
  ...
  app.use(createProxyMiddleware('/api/v1/social', { target: USER_SERVICE,     changeOrigin: true, pathRewrite: { '^/api/v1/social': '/social'  }, on: { error: onError } }));
  ...
  app.use(createProxyMiddleware('/api/v1/deliveries', { target: RIDE_SERVICE, changeOrigin: true, pathRewrite: { '^/api/v1/deliveries': '/rides/deliveries' }, on: { error: onError } }));
  ...
  app.use(createProxyMiddleware('/api/v1/rides', { target: RIDE_SERVICE,     changeOrigin: true, pathRewrite: { '^/api/v1/rides': '/rides'    }, on: { error: onError } }));
  ...
  app.use(createProxyMiddleware('/api/v1/fare',  { target: RIDE_SERVICE,     changeOrigin: true, pathRewrite: { '^/api/v1/fare':  '/rides/fare'}, on: { error: onError } }));
  ...
  app.use(createProxyMiddleware('/api/v1/disputes', { target: RIDE_SERVICE,     changeOrigin: true, pathRewrite: { '^/api/v1/disputes': '/rides/disputes' }, on: { error: onError } }));
  ...
  app.use(createProxyMiddleware('/api/v1/payments', { target: PAYMENT_SERVICE,  changeOrigin: true, pathRewrite: { '^/api/v1/payments': '/payments' }, on: { error: onError } }));
  ...
  app.use(createProxyMiddleware('/api/v1/location',   { target: LOCATION_SERVICE, changeOrigin: true, pathRewrite: { '^/api/v1/location':      '/location'         }, on: { error: onError } }));
  ...
  app.use(createProxyMiddleware('/api/v1/drivers',    { target: LOCATION_SERVICE, changeOrigin: true, pathRewrite: { '^/api/v1/drivers':       '/location/drivers' }, on: { error: onError } }));
  ...
  app.use(createProxyMiddleware('/api/v1/safety',     { target: LOCATION_SERVICE, changeOrigin: true, pathRewrite: { '^/api/v1/safety':        '/safety'           }, on: { error: onError } }));
  ...
  app.use(createProxyMiddleware('/api/v1/safety-zones', { target: LOCATION_SERVICE, changeOrigin: true, pathRewrite: { '^/api/v1/safety-zones':   '/safety-zones'   }, on: { error: onError } }));
};
